...
import Image1 from "/assets/bg-showcase-1.jpg";
import Image2 from "/assets/bg-showcase-2.jpg";
import Image3 from "/assets/bg-showcase-3.jpg";
function Imageshow() {
  return (
    <>
      {/* <!-- Image Showcases--> */}
        ...
        <div className="container-fluid p-0">
          <div className="row g-0 ">
            <div
              ...
              style={{
                backgroundImage: `url(../assets/img/bg-masterhead.jpg)`,
              }}
            ></div>
